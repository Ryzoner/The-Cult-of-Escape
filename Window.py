    ...
    def get_animations(self):
        self.anims['chainsaw'] = pyganim.PygAnimation(
            [
                (
                    self.settings['path']
                    + f'/assets/sprites/traps/chainsaw/chainsaw_{i}.png',
                    100,
                )
                for i in range(6)
            ]
        ...
        self.anims['vulkan'] = pyganim.PygAnimation(
            [
                (
                    self.settings['path']
                    + f'/assets/sprites/traps/vulkan/vulkan_{i}.png',
                    100,
                )
                for i in range(26)
            ]
        ...
        self.anims['ball'] = pyganim.PygAnimation(
            [
                (
                    self.settings['path']
                    + f'/assets/sprites/traps/ball/ball_{i}.png',
                    100,
                )
                for i in range(6)
            ]
        ...
        self.anims['box_glover'] = pyganim.PygAnimation(
            [
                (
                    self.settings['path']
                    + f'/assets/sprites/traps/box_glover/box_glover_{i}.png',
                    100,
                )
                for i in range(36)
            ]
...
class ShopWindow(Window):
    ...
    def get_buttons(self):
        ...
        button = Button(
            ...
            [46, 347])
        gui_path = self.settings['path'] + '/assets/sprites/icons/gui/'
        button.set_icon(f'{gui_path}yes.png')
        buttons['yes'] = button
        button = Button(
            '', 'no', self.manager,
            [126, 347])
        gui_path = self.settings['path'] + '/assets/sprites/icons/gui/'
        button.set_icon(f'{gui_path}no.png')
        buttons['no'] = button
        return buttons
